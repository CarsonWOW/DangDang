	...
	switch(obj.name) {
		...
		case "reDuPassword":
			if(obj.value == "") {
				...
				msgBox.className = "error";
				return false;
			} else if(obj.value != document.getElementById("duPassword").value) {
...
function ccc(){
	alert(111);
	var duUserName=document.getElementById("duUserName").value;
	if (duUserName=='' || duUserName==null){
		return false;
	}
	var duEmail=document.getElementById("duEmail").value;
	if (duEmail=='' || duEmail==null){
		return false;
	}
	var duPassword=document.getElementById("dduPassword").value;
	if (duPassword=='' || duPassword==null){
		return false;
	}
	var reDuPassword=document.getElementById("reDuPassword").value;
	if (reDuPassword=='' || reDuPassword==null){
		return false;
	}else if (reDuPassword!=duPassword){
		return false;
	}
