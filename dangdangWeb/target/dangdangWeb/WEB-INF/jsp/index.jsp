	...
	<div class="main">
		<div class="price-off">
			...
			<ul class="product clearfix">
				<c:forEach var="li" items="${ProductList}">
				<li>
					<dl>
						<dt><a href="product-view.jsp" target="_blank"><img src="${pageContext.request.contextPath}/images/product/${li.dpFileName}" /></a></dt>
						<dd class="title"><a href="product-view.jsp" target="_blank">${li.dpDescription}</a></dd>
						<c:if test="${User!=null}" var="flag">
							<a href="${pageContext.request.contextPath}/rest/Car/CarAdd?dpId=${li.dpId}">添加购物车</a>
						</c:if>
						<c:if test="${!flag}">
							<a href="${pageContext.request.contextPath}/rest/UserLogin">请登录添加购物车</a>
						</c:if>
						<dd class="price">￥${li.dpPrice}</dd>
					</dl>
					</c:forEach>
					</li>
				<%--</li>
				<li>
					<dl>
						<dt><a href="product-view.jsp" target="_blank"><img src="${pageContext.request.contextPath}/images/product/2.jpg" /></a></dt>
				...
				<li>
					<dl>
						<dt><a href="product-view.jsp" target="_blank"><img src="${pageContext.request.contextPath}/images/product/3.jpg" /></a></dt>
				...
				<li>
					<dl>
						<dt><a href="product-view.jsp" target="_blank"><img src="${pageContext.request.contextPath}/images/product/4.jpg" /></a></dt>
				...
				<li>
					<dl>
						<dt><a href="product-view.jsp" target="_blank"><img src="${pageContext.request.contextPath}/images/product/5.jpg" /></a></dt>
				...
				<li>
					<dl>
						<dt><a href="product-view.jsp" target="_blank"><img src="${pageContext.request.contextPath}/images/product/6.jpg" /></a></dt>
				...
				<li>
					<dl>
						<dt><a href="product-view.jsp" target="_blank"><img src="${pageContext.request.contextPath}/images/product/7.jpg" /></a></dt>
				...
				<li>
					<dl>
						<dt><a href="product-view.jsp" target="_blank"><img src="${pageContext.request.contextPath}/images/product/8.jpg" /></a></dt>
		...
		<div class="hot">
			...
			<ul class="product clearfix">
				<li>
					<dl>
						<dt><a href="product-view.jsp" target="_blank"><img src="${pageContext.request.contextPath}/images/product/1.jpg" /></a></dt>
				...
				<li>
					<dl>
						<dt><a href="product-view.jsp" target="_blank"><img src="${pageContext.request.contextPath}/images/product/9.jpg" /></a></dt>
				...
				<li>
					<dl>
						<dt><a href="product-view.jsp" target="_blank"><img src="${pageContext.request.contextPath}/images/product/10.jpg" /></a></dt>
...
<div id="footer">
	Copyright &copy; 2018 无涯 All Rights Reserved. 京ICP证1000001号
</div>
</body>
</html>
