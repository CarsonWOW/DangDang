...
<div id="position" class="wrap">
	您现在的位置：<a href="index.jsp">当当网</a> &gt; <a href="product-list.jsp">图书音像</a> &gt; 图书
</div>
	...
	<div class="main">
		<div class="product-list">
			...
			<ul class="product clearfix">
				...
				<li>
					<dl>
						<dt><a href="product-view.jsp" target="_blank"><img src="${pageContext.request.contextPath}/images/product/${u.dpFileName}" /></a></dt>
						<dd class="title"><a href="product-view.jsp" target="_blank">${u.dpName}</a></dd>
						<dd class="price">￥${u.dpPrice}</dd>
					</dl>
				</li>
				</c:forEach>
				<%--<li>
				...
				<tr>
					<td>
						...
						<c:if test="${pageInfo.pageNum>1}">
							<a href="${pageContext.request.contextPath}/rest/Product/ProductList?PageNow=1"> 首页</a>
							<a  href="${pageContext.request.contextPath}/rest/Product/ProductList?PageNow=${pageInfo.pageNum-1}">上一页</a>
						</c:if>

						<c:if test="${pageInfo.pageNum<pageInfo.pages}">
							<a href="${pageContext.request.contextPath}/rest/Product/ProductList?PageNow=${pageInfo.pageNum+1}">下一页</a>
							<a href="${pageContext.request.contextPath}/rest/Product/ProductList?PageNow=${pageInfo.pages}">末页</a>
						</c:if>
